...
//        TextField dateiNamenEingabe = new TextField();
//        Button bDateiAntragErstellen = new Button("Datei erstellen");
//        bDateiAntragErstellen.setOnAction(e -> dateiAntragErstellen());
//        bDateiAuswaehlen = new Button("Einlesen");
//        bDateiAuswaehlen.setOnAction(e -> { alleDateienNamen.schreibe(dateiNamenEingabe.getText() + ".txt\n", true);
...
//        box.getChildren().addAll(bDateiAntragErstellen, cbDateiOeffnen, dateiNamenEingabe, bDateiAuswaehlen);
//        return box;
//    }
//
...
//        System.out.println(cbDateiOeffnen.getSelectionModel().getSelectedItem());
//        if (cbDateiOeffnen.getSelectionModel().getSelectedItem() != null) {
//            datei = new Datei(cbDateiOeffnen.getSelectionModel().getSelectedItem());
//            datei.schreibe(text);
//        } else {
//            cbDateiOeffnen.requestFocus();
//        }
//    }
//}
